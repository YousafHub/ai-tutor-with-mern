...
const DashboardView = ({ insights }: DashboardViewProps) => {
    const salaryData: SalaryChartData[] = insights.salaryRanges.map((range) => ({
        name: range.role,
        min: range.min / 1000,
        max: range.max / 1000,
    ...
    const getMarketOutlookInfo = (outlook: string): { icon: any; color: string } => {
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card className="md:px-2">
                    ...
                    <CardContent className="md:pt-2.5">
