...
import { howItWorks, type HowItWorksItem } from "@/data/howItWorks";
import { testimonial, type Testimonial } from "@/data/testimonial";
            ...
            <Accordion className="w-full">
              {faqs.map((faq: FAQ, index: number) => (
                <AccordionItem key={index} value={`item-${index}`}>
                  ...
                  <AccordionContent className="animated">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
        ...
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <Button
              size="lg"
              variant="secondary"
              className="h-11 px-5 cursor-pointer mt-5 animate-bounce"
            >
